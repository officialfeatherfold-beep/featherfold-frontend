        ...
        <div className={`${viewMode === 'list' ? 'flex-1 p-0' : 'p-6'}`}>
          ...
          <motion.button
            ...
            className={`w-full py-3 rounded-xl font-semibold transition-all duration-300 ${
              product.availability > 0
                ? 'bg-gradient-to-r from-stone-600 to-amber-600 hover:from-stone-700 hover:to-amber-700 text-white'
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <motion.button
                    ...
                    className="w-full py-4 bg-gradient-to-r from-stone-600 to-amber-600 hover:from-stone-700 hover:to-amber-700 text-white rounded-xl font-semibold transition-all"
