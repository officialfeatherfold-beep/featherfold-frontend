          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    {order.shiprocketCourierName && (
                      <span className="px-3 py-1 rounded-full bg-stone-50 text-stone-700 text-xs font-medium">
                        {order.shiprocketCourierName}
                      </span>
                    )}
                  </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6">
                ...
                <div className="relative">
                  <motion.div
                    className="absolute left-6 top-2 bottom-2 w-0.5 bg-gradient-to-b from-stone-200 via-amber-200 to-stone-200"
                    initial={{ scaleY: 0 }}
                    animate={{ scaleY: 1 }}
                  ...
                  />
                  <motion.div
                    className="absolute left-[22px] top-2 w-3 h-3 rounded-full bg-stone-400 shadow-md"
                    animate={{ y: ['0%', '100%', '0%'] }}
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            ...
                            {isActive && (
                              <motion.span
                                className="absolute inset-0 rounded-full border-2 border-stone-300/60"
                  ...
                  <div className="space-y-3 max-h-72 overflow-y-auto">
                    {sortedEvents.map((event, index) => (
                      <div key={index} className="border border-gray-100 rounded-xl p-4">
                        ...
                        {event.location && (
                          <p className="text-xs text-stone-600 mt-2">{event.location}</p>
                        )}
                      </div>
                    ))}
                  </div>
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-2xl shadow-lg p-6">
                ...
                <div className="aspect-square rounded-xl overflow-hidden bg-white border border-stone-100 relative">
                  {hasAwb ? (
                    <div className="h-full w-full bg-gradient-to-br from-stone-50 to-amber-50 flex items-center justify-center text-center px-4 relative">
                      <div className="relative">
                        <motion.div
                          className="absolute -inset-6 rounded-full border-2 border-stone-300/60"
                          animate={{ scale: [1, 1.4, 1], opacity: [0.5, 0.2, 0.5] }}
                          transition={{ duration: 2.4, repeat: Infinity }}
                        />
                        <MapPin className="w-10 h-10 text-stone-500 mx-auto mb-2 relative z-10" />
                      </div>
